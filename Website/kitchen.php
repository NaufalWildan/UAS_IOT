...
<head>
    ...
    <title>IOT UAS Kelompok Gacor</title>
...
<body>
    <div class="container-samping">
        <a href="index.php">
            <div class="logo" style="font-weight: bold; font-size: 30px;">
            <img style="width: 50px;" src="https://cdn-icons-png.flaticon.com/128/9630/9630732.png" alt="">
            Connected
        </div>
        </a>
       <a href="bath.php">
    ...
    <div class="content">
        <table id="example" class="display" style="width:100%">
            ...
            include "data.php";
            $no = 1;
            $query = mysqli_query($con, 'SELECT * FROM `iotuasdata` WHERE `topic` = "uas/iot/suhu/kitchen" OR `topic`= "uas/iot/kelembapan/kitchen";');
